r"""Contains definitions for Residual Networks.
...
def convert_dtype(dtype, obj):
	...
	r"""Converts given tensor to given dtype
...
def batch_norm(num_features):
	...
	r"""Create a batch normalization layer.
...
class BasicBlockV1(nn.Module):
	...
	r"""The basic block in :cite:`he2016deep` is used for shallower ResNets.
...
class ResNet18CIFAR10(nn.Module):
	...
	r"""ResNet implementation for CIFAR-10
...
def resnet18_bkj(num_classes):
	...
	r"""Constructs a ResNet-18 model from DAWN.
	
		This `implementation <https://github.com/bkj/basenet/blob/49b2b61e5b9420815c64227c5a10233267c1fb14/examples/cifar10.py>`_
